...
export const gridItems = [
  ...
  {
    id: 2,
    title: "Adapting to any tech stack as per project needs.",
    description: "",
  ...
  {
    id: 4,
    title: "Tech enthusiast with a passion for research & development.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a NFT based authentication system",
...
export const projects = [
  {
    id: 1,
    title: "Full Stack POS Application",
